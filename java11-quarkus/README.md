...
You can then execute your native executable with: `./build/java11-quarkus-1.0-SNAPSHOT-runner`
...
Discover WebSockets using Undertow with this cool supersonic chat example. Open multiple tabs to simulate different
users.
